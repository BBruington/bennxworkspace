  ...
  return (
    <>
      ...
      {/* We've used 3xl here, but feel free to try other max-widths based on your needs */}
        <div className="mt-5 mx-auto max-w-2xl text-white-200 bg-gray-500 border border-gray-600 rounded-md">{/* Content goes here */}
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc porta feugiat efficitur. Proin laoreet risus eget odio vulputate, eu tincidunt tellus vestibulum. Nullam nec dui vel felis ultrices dictum. Fusce at tellus scelerisque, malesuada odio in, condimentum velit. Duis pretium elit tortor, a vestibulum urna commodo sit amet. Donec iaculis ac eros id pellentesque. Donec quis lacinia quam, auctor scelerisque massa. In commodo erat sed arcu lacinia lacinia. Aenean at imperdiet ligula. Vestibulum sit amet pellentesque odio, sit amet mattis nibh. Ut feugiat eget sem in elementum. Nulla blandit magna non nibh interdum imperdiet.
